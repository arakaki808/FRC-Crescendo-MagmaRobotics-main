...
public class DriveTrain extends SubsystemBase {
    ...
    private RelativeEncoder fLRotateEncoder;
    ...
    public DriveTrain() {
        ...
        fLRotateEncoder = frontLeftDriveMotor.getEncoder();
        ...
        frontLeftDriveMotorEncoder.setPositionConversionFactor(.2);
        frontRightDriveMotorEncoder.setPositionConversionFactor(.2);
        fLRotateEncoder.setPositionConversionFactor(.2);
    ...
    public double getLeftRotateEncoderPos() {
        return fLRotateEncoder.getPosition();
    }
    ...
    public void periodic() {
        SmartDashboard.putNumber("Left Encoder", frontLeftDriveMotorEncoder.getPosition());
        SmartDashboard.putNumber("Left Rotate Encoder", fLRotateEncoder.getPosition());
    }
